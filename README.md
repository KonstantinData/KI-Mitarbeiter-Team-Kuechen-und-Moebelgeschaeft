...
| Tenant `liquisto` | Olivia: interne Assistenz für Information und nicht ausführbare Entwürfe; provider-sideband-attestierte Voice-Runtime mit genau einer allowgelisteten, semantischen Workbench-Navigation und ohne URL-, Browser- oder Schreibzugriff ([Vertrag](docs/liquisto-assistant-runtime.md)) |
